                    ...
                    <div className='flex flex-col gap-4 md:flex-row md:justify-between items-center '>
                        ...
                        <div className='flex gap-2 justify-center '>
                            ...
                            {Array.isArray(contactData) && contactData.map((d) => {
                                ...
                                let icon = null
                                if (title === 'Facebook') icon = <Image src={fb} alt="Facebook" width={26} />
                                else if (title === 'Instagram' || title === 'Instragram') icon = <Image src={insta} alt="Instagram" width={32} />
                                else if (title === 'Twitter') icon = <Image src={x} alt="Twitter" width={28} />
