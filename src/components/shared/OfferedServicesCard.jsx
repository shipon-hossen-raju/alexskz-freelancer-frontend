      ...
      <div className="flex flex-col md:flex-row gap-4 ">
        <div className="flex justify-center md:justify-start  ">
          <Image
            ...
            alt="image"
            className="rounded-[10px] w-[137px] min-h-[127px] object-cover"
            width={100}
            height={100}
          />
        </div>
        <div className="flex flex-col gap-2 justify-between items-center md:items-start flex-1">
          <h3 className="font-open-sans font-semibold text-black text-xl">
            {service.title}
          </h3>
      ...
      <div>
        {profile && (
          <div className="flex items-center gap-1">
            <button
              onClick={onEdit}
              className="cursor-pointer p-1 rounded-md hover:bg-gray-100 focus:outline-none"
            >
