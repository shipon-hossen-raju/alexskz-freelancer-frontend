...
import imageSrc from "@/assets/image/authImg.webp";
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.05fr_1fr] rounded-[28px] overflow-hidden">
          ...
          <div className="bg-white px-5 sm:px-8 md:px-10 py-6 md:py-10 md:rounded-r-[28px] ">
            <div className="flex justify-between">
              ...
              {step && <p className="text-[#7DBA8B] font-open-sans ">{step}</p>}
            </div>
            ...
            <div className="mb-6 flex items-start justify-between ">
              <div>
                ...
                {subtitle ? (
                  <p className="text-[13px] sm:text-sm text-[#9F9C96] mt-1 font-open-sans">
                    {subtitle}
                  </p>
                ) : null}
              </div>
