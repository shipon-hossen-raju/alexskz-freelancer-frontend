...
export default function FreelancerDetailsPage({ params }) {
  ...
  if (!user) {
    ...
    router.push(`/sign-in?redirect=/details/${slug}`);
  }

  const { data, isLoading, isError, error } =
    useGetProfileForPublicViewQuery(slug);
      ...
      <div className=" ">
        ...
        <div className="relative h-[60vh]">
          <Image
            ...
            alt="cover-photo"
            className="rounded-[8px] lg:h-[60vh] object-cover"
            fill
          />
        </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex  gap-1 items-center">
              ...
              <p className="text-[#333333] font-open-sans text-sm lg:text-xl">
                {profileData?.rating?.ratingAvg || 0}
              </p>
