...
export const { setCategoryIds, setMinPrice, setMaxPrice, setIsOnline, setTopRated, setIsCertified, clearCategoryIds, clearMinPrice, clearMaxPrice, clearIsOnline, clearTopRated, clearIsCertified } = filterSlice.actions;
